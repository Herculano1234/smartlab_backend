...
app.get("/rfid/uid-disponivel", async (req, res) => {
  try {
    // Retorna lista de UIDs disponíveis (não cadastrados)
    // Útil para testar no cadastro
    const [estagiarios] = await pool.query(
